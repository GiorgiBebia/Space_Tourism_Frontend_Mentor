...
function LaunchVehicle() {
  useEffect(function () {
    document.title = `Launch Vehicle | Space Tourism | Frontend Mentor`;
  }, []);
  ...
  return (
    <div className="w-[1110px] tablet:w-[768px] mobile:w-[375px] h-[792px] tablet:h-[928px] mobile:h-[792px] mt-[48px] tablet:mt-[40px] mx-auto">
      ...
      <img
        ...
        src="img/technology/image-launch-vehicle-landscape.jpg"
        alt=""
      />
      <img
        className="hidden mobile:block w-[375px] h-[258px] mt-[88px]"
        src="img/technology/image-launch-vehicle-portrait.jpg"
        alt=""
      />
